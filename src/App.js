...
function App() {
  ...
  const navStyle = { margin: "20px", padding: "20px", color: "cyan", fontSize: "20px", textDecoration: "none", float: "left" }
  return (
          ...
          <Router>
            <nav>
              ...
              <div className="navbar">
                ...
                <Link to="/Login" style={{ margin: "20px", padding: "20px", textDecoration: "none" }}><button>{userUpdate.email ? `Welcome ${userUpdate.displayName}` : `Login Or SignUp`}</button></Link>
              </div>
            </nav>
            <Switch>
              <Route exact path="/">
